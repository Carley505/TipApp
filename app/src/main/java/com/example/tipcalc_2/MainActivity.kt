...
import com.example.tipcalc_2.ui.theme.TipCalc2Theme
...
fun TipTimeLayout() {
    ...
    val percent = tipPercentInput.toDoubleOrNull() ?: 0.0

    val tip = calculateTip(amount = amount, tipPercent = percent, roundUp = toggleSwitch)
    Column(
        ...
        RoundTipSwitch(
            value = toggleSwitch,
            onCheckedChange = { toggleSwitch = it },
            modifier = Modifier.padding(bottom = 32.dp).fillMaxWidth()
        )
        Text(
